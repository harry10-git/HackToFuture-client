    ...
    <div>
      <div className="mt-5 w-[70%] justify-center items-center mx-auto">
        ...
        <input
          type="radio"
          name="cat"
          checked={cat === "electricals"}
          value="electricals"
          id="electricals"
          onChange={(e) => setCat(e.target.value)}
        />
        <label className="mr-2" htmlFor="electricals">Electrical</label>

        <input
          type="radio"
          name="cat"
          checked={cat === "vehicles"}
          value="vehicles"
          id="vehicles"
          onChange={(e) => setCat(e.target.value)}
        />
        <label className="mr-2" htmlFor="vehicles">vehicle</label>
